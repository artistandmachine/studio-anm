        ...
        <div className="flex min-w-0 flex-1 flex-col items-center">
          {years.map((year) => (
            <div key={year} className="flex w-full items-start">
              <div className="flex w-[15%] flex-col items-center self-stretch py-[90px]">
                <div className="h-[50vh] w-full shrink-0" />
                <StickyLabel>{year}</StickyLabel>
              </div>
              <div className="flex min-w-0 flex-1 flex-col items-start gap-[50px] py-[90px]">
